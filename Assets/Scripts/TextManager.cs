...
public class TextManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Itext.text = "기력 : " + player.maxEnergy.ToString("F2") + " \n(+3.5%) , 가격 상승률: +5%\n\n" +
        "물고기 : " + "기력: +" + fishData.energy.ToString("F2") + " 점수: +" + fishData.score.ToString("F2") + "\n(각, +1.5%, +3%),  가격 상승률: +7%\n\n"
        + "항해 : " + "고래: +" + fishData.whalescore.ToString("F2") + " 보너스: x" + levelManager.bonusdistance.ToString("F2") + "\n(각, +2.5%, 1.5%) 가격 상승률: +3.5%\n\n";
